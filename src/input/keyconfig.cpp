...
static void initializeKeyFunctions(std::vector<KeyFunctionInfo>& entries)
{
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_QuickSave,                                                  "QuickSave",                    N_("QuickSave"),                                    {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_F10                                     } }}));
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::BACKGROUND,          KeyMappingType::FIXED,       kf_ScreenDump,                                                 "ScreenDump",                   N_("Take Screen Shot"),                             {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_F7                                      } }}));
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_ScrollCamera(0, 1),                                         "CameraUp",                     N_("Move Camera Up"),                               {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_UPARROW,    KeyAction::DOWN             } }, { KeyMappingSlot::SECONDARY, { KEY_CODE::KEY_W, KeyAction::DOWN } }}));
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_ScrollCamera(0, -1),                                        "CameraDown",                   N_("Move Camera Down"),                             {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_DOWNARROW,  KeyAction::DOWN             } }, { KeyMappingSlot::SECONDARY, { KEY_CODE::KEY_S, KeyAction::DOWN } }}));
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_ScrollCamera(1, 0),                                         "CameraRight",                  N_("Move Camera Right"),                            {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_RIGHTARROW, KeyAction::DOWN             } }, { KeyMappingSlot::SECONDARY, { KEY_CODE::KEY_D, KeyAction::DOWN } }}));
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_ScrollCamera(-1, 0),                                        "CameraLeft",                   N_("Move Camera Left"),                             {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_LEFTARROW,  KeyAction::DOWN             } }, { KeyMappingSlot::SECONDARY, { KEY_CODE::KEY_A, KeyAction::DOWN } }}));
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_RotateLeft,                                                 "RotateLeft",                   N_("Rotate Left"),                                  {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_KP_4,       KeyAction::DOWN             } }, { KeyMappingSlot::SECONDARY, { KEY_CODE::KEY_E, KeyAction::DOWN } }}));
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_RotateRight,                                                "RotateRight",                  N_("Rotate Right"),                                 {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_KP_6,       KeyAction::DOWN             } }, { KeyMappingSlot::SECONDARY, { KEY_CODE::KEY_Q, KeyAction::DOWN } }}));
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_JumpToUnassignedUnits,                                      "JumpToUnassignedUnits",        N_("View Unassigned Units"),                        {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_J                                       } }}));
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_SetDroid(DSO_ATTACK_LEVEL, DSS_ALEV_ATTACKED),              "SetDroidAttackReturn",         N_("Return Fire"),                                  {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_V                                       } }}));
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_SetDroid(DSO_PATROL, DSS_PATROL_SET),                       "SetDroidMovePatrol",           N_("Patrol"),                                       {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_X                                       } }}));
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_OrderDroid(DORDER_STOP),                                    "SetDroidOrderStop",            N_("Stop Droid"),                                   {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_K                                       } }}));
	...
	entries.emplace_back(KeyFunctionInfo(InputContext::GAMEPLAY,            KeyMappingType::ASSIGNABLE,  kf_SelectUnits(DST_ALL_COMBAT),                                "SelectAllCombatUnits",         N_("Select all Combat Units"),                      {{ KeyMappingSlot::PRIMARY, { KEY_CODE::KEY_LCTRL,      KEY_CODE::KEY_A             } }, { KeyMappingSlot::SECONDARY, { KEY_CODE::KEY_SPACE } }}));
